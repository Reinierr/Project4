...
namespace App1.Droid
{
    ...
    public class piechart : Activity
    {
        ...
        {
            var modelP1 = new PlotModel { Title = "Most stolen bike brands" , TitleFontSize = 24};

            var seriesP1 = new PieSeries { StrokeThickness = 2.0, InsideLabelPosition = 0.8, AngleSpan = 360, StartAngle = 0 ,FontSize = 24};
